        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    {{-- <div>
                        <h4 class="mb-4 text-lg font-bold">Create Catecory</h4>
                        <form action="{{ route('category.store') }}" method="post">
                            @csrf
                            <div class="mb-4">
                                <label for="name" class="blog-label">Category Name</label>
                                <input name="name" id="name" type="text" class="blog-input" placeholder="Enter category" value="{{ old('name') }}">
                            ...
                            <button type="submit" class="blog-btn">Create Category</button>
                        </form>
                    </div> --}}
