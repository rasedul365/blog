        ...
        <table class="w-full whitespace-nowrap">
            <thead>
                <tr>
                    ...
                    <th class="px-4 py-2 text-left border">Is Approve</th>
                    <th class="px-4 py-2 text-left border">Image</th>
                    <th class="px-4 py-2 text-left border">Category</th>
                    <th class="px-4 py-2 text-left border">Sub Category</th>
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 text-center border ">
                        <div class="flex justify-center">
                            <a class="mr-2"
                                href="">@include('components.icons.edit')</a>
                            <a class="mr-2"
                                href="">@include('components.icons.eye')</a>
