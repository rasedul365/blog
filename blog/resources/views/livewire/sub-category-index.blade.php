            ...
            <table class="w-full whitespace-nowrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2 border">{{ $data->categories->name }}</td>
                        ...
                        <td class="px-4 py-2 text-center border ">
                            <div class="flex justify-center">
                                <a class="mr-2" href="{{ route('sub-category.edit', $data->id) }}">@include('components.icons.edit')</a>
                                <a class="mr-2" href="{{ route('sub-category.show', $data->id) }}">@include('components.icons.eye')</a>
                                <form wire:submit.prevent='subCategoryDelete({{ $data->id }})'>
